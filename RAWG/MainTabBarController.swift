...
class MainTabBarController: UITabBarController {
    ...
    private func setupTabs() {
        ...
        let searchVC = self.createNavigationChain(title: "Search", image: UIImage(systemName: "magnifyingglass") ?? UIImage(), vc: HomeViewController(nibName: String(describing: SearchViewController.self), bundle: nil))
        let featureVC = self.createNavigationChain(title: "Feature", image: UIImage(systemName: "star") ?? UIImage(), vc: HomeViewController(nibName: String(describing: FeaturedViewController.self), bundle: nil))
